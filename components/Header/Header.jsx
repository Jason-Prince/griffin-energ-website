    ...
    <>
      <div className={styles.fixedContainer}>
        <div className={styles.headerGrid}>
          {/* Logo */}
          <svg className={styles.headerLogo} viewBox="0 0 2298.41 170.62">
            <g>
              <path
              ...
              />
              <path className={styles.cls1} d="M1896.56,1.14h23v138.7h-23Z" />
              <path
                className={styles.cls1}
          ...
          {/* menuToggle */}
          <div className={`${styles.cross} ${styles.menuToggle}`}>
